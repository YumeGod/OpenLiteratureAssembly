...
public enum EnumFacing implements IStringSerializable
{
    ...
    private EnumFacing(String p_i31_3_, int p_i31_4_, int p_i31_5_, int p_i31_6_, int p_i31_7_, String p_i31_8_, AxisDirection p_i31_9_, Axis p_i31_10_, Vec3i p_i31_11_)
    {
        this.index = p_i31_5_;
        this.horizontalIndex = p_i31_7_;
        this.opposite = p_i31_6_;
        this.name = p_i31_8_;
        this.axis = p_i31_10_;
        this.axisDirection = p_i31_9_;
        this.directionVec = p_i31_11_;
    }
    ...
    public static enum Axis implements Predicate, IStringSerializable {
        ...
        private Axis(String p_i28_3_, int p_i28_4_, String p_i28_5_, Plane p_i28_6_)
        {
            this.name = p_i28_5_;
            this.plane = p_i28_6_;
        }
    ...
    public static enum AxisDirection {
        ...
        private AxisDirection(String p_i29_3_, int p_i29_4_, int p_i29_5_, String p_i29_6_)
        {
            this.offset = p_i29_5_;
            this.description = p_i29_6_;
        }
    ...
    public static enum Plane implements Predicate, Iterable {
        ...
        private Plane(String p_i30_3_, int p_i30_4_)
        {
        }
