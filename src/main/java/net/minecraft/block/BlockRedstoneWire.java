...
public class BlockRedstoneWire extends Block {
	public static final PropertyEnum<EnumAttachPosition> NORTH = PropertyEnum.<EnumAttachPosition> create(
			"north", EnumAttachPosition.class);
	public static final PropertyEnum<EnumAttachPosition> EAST = PropertyEnum.<EnumAttachPosition> create(
			"east", EnumAttachPosition.class);
	public static final PropertyEnum<EnumAttachPosition> SOUTH = PropertyEnum.<EnumAttachPosition> create(
			"south", EnumAttachPosition.class);
	public static final PropertyEnum<EnumAttachPosition> WEST = PropertyEnum.<EnumAttachPosition> create(
			"west", EnumAttachPosition.class);
	...
	public BlockRedstoneWire() {
		...
		this.setDefaultState(this.blockState.getBaseState()
				...
				.withProperty(WEST, EnumAttachPosition.NONE).withProperty(POWER, Integer.valueOf(0)));
	...
	private EnumAttachPosition getAttachPosition(IBlockAccess worldIn, BlockPos pos,
	...
	public int colorMultiplier(IBlockAccess worldIn, BlockPos pos, int renderPass) {
		...
		return iblockstate.getBlock() != this ? super.colorMultiplier(worldIn, pos, renderPass)
