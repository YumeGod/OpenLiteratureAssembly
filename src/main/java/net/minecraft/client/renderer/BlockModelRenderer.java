...
public class BlockModelRenderer
{
    ...
    public static enum EnumNeighborInfo
    {
        ...
        private EnumNeighborInfo(String p_i7_3_, int p_i7_4_, EnumFacing[] p_i7_5_, float p_i7_6_, boolean p_i7_7_, Orientation[] p_i7_8_, Orientation[] p_i7_9_, Orientation[] p_i7_10_, Orientation[] p_i7_11_)
        {
            this.field_178276_g = p_i7_5_;
            this.field_178288_h = p_i7_6_;
            this.field_178289_i = p_i7_7_;
            this.field_178286_j = p_i7_8_;
            this.field_178287_k = p_i7_9_;
            this.field_178284_l = p_i7_10_;
            this.field_178285_m = p_i7_11_;
        }
    ...
    static enum VertexTranslations
    {
        ...
        private VertexTranslations(String p_i8_3_, int p_i8_4_, int p_i8_5_, int p_i8_6_, int p_i8_7_, int p_i8_8_)
        {
            this.field_178191_g = p_i8_5_;
            this.field_178200_h = p_i8_6_;
            this.field_178201_i = p_i8_7_;
            this.field_178198_j = p_i8_8_;
        }
