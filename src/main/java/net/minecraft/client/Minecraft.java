...
import just.monika.主播为什么开我端子.eventapi.Event.State;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private PlayerUsageSnooper usageSnooper = new PlayerUsageSnooper("just/monika/主播为什么开我端子", this, MinecraftServer.getCurrentTimeMillis());
    ...
    {
    	new UseItemEvent(State.PRE).call();
        ...
        new UseItemEvent(State.POST).call();
    }
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Mouse.next())
            {
                ...
                {
                	MouseEvent eventMouse = new MouseEvent(i);
        		    eventMouse.call();
