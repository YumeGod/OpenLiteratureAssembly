...
import just.monika.主播为什么开我端子.modules.movement.Fly;
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            if (this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z))
            {
                ...
                if (this == Minecraft.getMinecraft().thePlayer && bypass) {
            ...
            this.onGround = (((ModuleManager.getModule(Fly.class).enabled) && (this == Minecraft.getMinecraft().thePlayer)) || ((this.isCollidedVertically) && (d4 < 0.0D)));
