...
public class FlexibleArray<T> implements Iterable<T> {
	...
	/**
	 * Creates a new instance of the FlexibelArray class with a preset array
	 * containing <T> instances.
	 * 
	 * @param array
	 ...
	 * 
	 * @param t
	 *            Instance of <T> that you want to know of if it's in the
	 *            FlexibleArray.
	 * @return True if the FlexibleArray contains "t".
	 */
	 ...
	 * @return Instance of <T> stored at the location of the index.
	 */
	...
	/**
	 * @return The amount of instances of <T> that are stored.
	 */
	public int size() {
	...
	/**
	 * @return Array containing all instances of <T>.
	 */
	public T[] array() {
		return elements;
	}
	...
	/**
	 * @return True if the FlexibleArray doesn't contain any Objects.
	 */
