 ...
 */
package just.monika.主播为什么开我端子.ui;

import java.util.ArrayList;
import java.util.List;

import just.monika.主播为什么开我端子.Client;
import just.monika.主播为什么开我端子.management.module.Category;
...
import just.monika.主播为什么开我端子.util.StringUtil;
...
public class TabGui
{
    ...
    public static void init() {
        ...
        for (int length = (values = Category.values()).length, i = 0; i < length; ++i) {
            ...
            final int stringWidth = Client.font.getStringWidth(name);
    ...
    public static void render() {
        ...
        for (int i = 0; i < Category.values().length; ++i) {
            ...
            final String name = StringUtil.capitalize(category.name().toLowerCase());
            Client.font.drawStringWithShadow(name, TabGui.baseCategoryWidth / 2 - Client.font.getStringWidth(name) / 2 + 3, yPos + 3, -1);
            yPos += 14;
            yPosBottom += 14;
        }
        if (TabGui.section == Section.MODS) {
            ...
            for (int i = 0; i < getModsInCategory(Category.values()[TabGui.categoryTab]).size(); ++i) {
                ...
                Client.font.drawStringWithShadow(name, TabGui.baseCategoryWidth + TabGui.baseModWidth / 2 - Client.font.getStringWidth(name) / 2 + 3, yPos + 3, mod.enabled ? -1 : -4210753);
                yPos += 14;
                yPosBottom += 14;
            }
        }
