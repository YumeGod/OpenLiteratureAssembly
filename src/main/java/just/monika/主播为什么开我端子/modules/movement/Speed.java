...
import just.monika.主播为什么开我端子.management.option.options.speed.Basic;
import just.monika.主播为什么开我端子.management.option.options.speed.Bhop;
import just.monika.主播为什么开我端子.management.option.options.speed.Boost;
import just.monika.主播为什么开我端子.management.option.options.speed.MineZ;
import just.monika.主播为什么开我端子.management.option.options.speed.SpeedOption;
...
import just.monika.主播为什么开我端子.util.MathUtils;
        ...
        switch (s = currentMode) {
            case "Bhop": {
                ...
                if (this.stage == 1 && (this.mc.thePlayer.moveForward != 0.0f || this.mc.thePlayer.moveStrafing != 0.0f)) {
                    ...
                    if (this.mc.theWorld.getCollidingBoundingBoxes((Entity)this.mc.thePlayer, this.mc.thePlayer.boundingBox.offset(0.0, this.mc.thePlayer.motionY, 0.0)).size() > 0 || this.mc.thePlayer.isCollidedVertically) {
                        this.stage = 1;
                    }
