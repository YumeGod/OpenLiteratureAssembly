...
public class CustomColors
{
    ...
    private static final IColorizer COLORIZER_WATER = new IColorizer()
    {
        ...
        {
            BiomeGenBase biomegenbase = CustomColors.getColorBiome(p_getColor_1_, p_getColor_2_);
            return CustomColors.waterColors != null ? CustomColors.waterColors.getColor(biomegenbase, p_getColor_2_) : (Reflector.ForgeBiomeGenBase_getWaterColorMultiplier.exists() ? Reflector.callInt(biomegenbase, Reflector.ForgeBiomeGenBase_getWaterColorMultiplier, new Object[0]) : biomegenbase.waterColorMultiplier);
        }
        public boolean isColorConstant()
        {
            return false;
